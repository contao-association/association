...
detaillierter Beschreibung über den Einsatz der Mittel, einen detailliertem Zeitplan und eine
detaillierten Kostenaufstellung beinhalten. Der Vorstand entscheided ob der Antrag den
Zielen der Contao Association entspricht und stellt diesen dann innerhalb eines angemessenen
Zeitraums zur Abstimmung.

Die Abstimmung gilt als angenommen, wenn nach Ende der Abstimmungsphase die Abstimmung eine
relative Mehrheit an Ja stimmen erhalten hat. Wird der Antrag angenommen, muss der Vorstand
die Umsetzung in einem angemessenen Zeitraum in Auftrag geben.
